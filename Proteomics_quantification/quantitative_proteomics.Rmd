...
| [MS Stats](TODO) | Bioinformatic pipeline | Suite of tools for proteomics that can be chained to build pipelines. |
...
inputProteins <- as.matrix(proteinGroups[, ])
...
ratiosDF$orderedProteins <- factor(ratiosDF$proteinRank, levels = hclust$order)
