...
:pencil2: Create a new project via the _File_ -> _New Projet_ menu. Select _New Directory_ -> _Empty Project_, and select a folder for your project. Create a new script via the _File_ -> _New File_ -> _R Script_ menu. 
